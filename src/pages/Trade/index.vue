<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" @click="changePay()">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="order in orderInfo.detailArrayList" :key="order.skuId">
          <li>
            <img :src="order.imgUrl" alt="" style="width:130px;height:120px">
          </li>
          <li>
            <p>{{ order.skuName }}</p>
            <h4>7天无理由退货</h4>
...
export default {
  ...
  computed: {
    ...
    tradeNo() {
      return this.orderInfo.tradeNo
    }
  },
  methods: {
    changeDefault(address, arr) {
      arr.forEach(item => {
        // console.log(item)
        item.isDefault = '0'
      });
